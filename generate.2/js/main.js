...
for (var dots = 0; dots < 100; dots++) {
    ...
    $(".container2").append("<div class='triangle'></div>");
    $(".container3").append("<div class='triangle'></div>");
}

for (var dots2 = 0; dots2 < 100; dots2++) {
    $(".container1").append("<div class='triangle2'></div>");
    $(".container2").append("<div class='triangle2'></div>");
    $(".container3").append("<div class='triangle2'></div>");
}
